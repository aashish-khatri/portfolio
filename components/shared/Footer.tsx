    ...
    <footer className="py-16 bg-bg-secondary border-t border-border-primary text-center">
      <div className="container mx-auto px-6">
        <div className="flex justify-center items-center gap-8 mb-6">
          ...
          <a href="https://www.linkedin.com/in/aashish--khatri/" target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-text-primary transition-colors">LinkedIn</a>
