      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {featuredProjects.map((project) => (
            <div key={project.id} className="bg-bg-primary border border-border-primary rounded-xl overflow-hidden transition-all hover:-translate-y-2 hover:shadow-xl hover:border-accent group">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {otherProjects.map((project) => (
            <div key={project.id} className="bg-bg-secondary border border-border-primary rounded-lg p-6 hover:bg-bg-tertiary transition-colors">
